...
// Keycodes
    ...
    QK_KEY_CANCELLATION_RECOVERY_ON = 0x7C7E,
    QK_KEY_CANCELLATION_RECOVERY_OFF = 0x7C7F,
    QK_KEY_CANCELLATION_RECOVERY_TOGGLE = 0x7C80,
    QK_KB_0 = 0x7E00,
    QK_KB_1 = 0x7E01,
    QK_KB_2 = 0x7E02,
    QK_KB_3 = 0x7E03,
...
// Alias
    ...
    KX_REON    = QK_KEY_CANCELLATION_RECOVERY_ON,
    KX_REOF    = QK_KEY_CANCELLATION_RECOVERY_OFF,
    KX_RETG    = QK_KEY_CANCELLATION_RECOVERY_TOGGLE,
};
...
#define IS_QUANTUM_KEYCODE(code) ((code) >= QK_BOOTLOADER && (code) <= QK_KEY_CANCELLATION_RECOVERY_TOGGLE)
...
#define QUANTUM_KEYCODE_RANGE               QK_BOOTLOADER ... QK_KEY_CANCELLATION_RECOVERY_TOGGLE
